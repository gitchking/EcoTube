  ...
  return (
    <section className="py-12 bg-ocean-100 dark:bg-black">
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          <div className="bg-blue-100 dark:bg-gray-800 border-3 border-blue-300 dark:border-gray-600 rounded-comic p-6 border-2 border-black dark:border-white">
            <h3 className="text-lg font-bold text-blue-700 dark:text-white mb-2 font-comic">Contact Information</h3>
            <p className="text-blue-600 dark:text-gray-300 font-nunito">
          ...
          <div className="bg-green-100 dark:bg-gray-800 border-3 border-green-300 dark:border-gray-600 rounded-comic p-6 border-2 border-black dark:border-white">
            <h3 className="text-lg font-bold text-green-700 dark:text-white mb-2 font-comic">Fair Use Reminder</h3>
