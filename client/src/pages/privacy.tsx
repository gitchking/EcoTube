  ...
  return (
    <section className="py-12 bg-forest-50 dark:bg-black">
      <div className="max-w-4xl mx-auto px-4">
        ...
        >
          <div className="bg-gray-800 border-3 border-gray-600 rounded-comic p-6 border-2 border-white">
            <h3 className="text-lg font-bold text-gray-200 mb-2 font-comic">Questions About Privacy?</h3>
